...
public class YCSBClient extends DB {
	...
	public int insert(String table, String key,
		...
		System.out.println("-----------replyMsg.getResult();-------------" + replyMsg.getResult());
		return replyMsg.getResult();
	}


	// read() -> !=null abort() ; == null "", write() + commit() end transaction

	// read() end transaction

	// update() -> read() + write() + commit()  end transaction
