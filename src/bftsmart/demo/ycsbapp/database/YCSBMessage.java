...
public class YCSBMessage implements Serializable {
	...
	public enum Type {
			...
			READ(1), WRITE(2), COMMIT(3), READALL(0);
		int type;
...
//	}
	...
	public static YCSBMessage newUpdateRequest(String table, String key, HashMap<String, byte[]> values, String ptid) {
		YCSBMessage message = new YCSBMessage();
	...
	public static YCSBMessage newReadAllRequest(String table) {
		YCSBMessage message = new YCSBMessage();
		message.type = Type.READALL;
		//message.entity = Entity.RECORD;
		return message;
	}

	public static YCSBMessage newReadRequest(String table, String key, Set<String> fields, HashMap<String, byte[]> results, String ptid) {
		YCSBMessage message = new YCSBMessage();
	...
	public static YCSBMessage newCommitRequest(String table, String key, Set<String> fields, HashMap<String, byte[]> results, String ptid) {
		YCSBMessage message = new YCSBMessage();
...
//	}
	...
	public String toString() {
		...
		sb.append(table).append(",").append(key).append(",").append(fields).append(",").append(values).append(",").append(ptid).append(")");
		return sb.toString();
	}
